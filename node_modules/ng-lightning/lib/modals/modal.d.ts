...
export declare class NglModal implements OnChanges, AfterContentInit, OnDestroy {
    ...
    private handleOpen;
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<NglModal, never>;
    static ɵcmp: ɵngcc0.ɵɵComponentDeclaration<NglModal, "ngl-modal", never, { "header": "header"; "directional": "directional"; "open": "open"; "closeButtonAssistiveText": "closeButtonAssistiveText"; "dismissOnClickOutside": "dismissOnClickOutside"; "size": "size"; "prompt": "prompt"; }, { "openChange": "openChange"; }, ["headerTpl", "taglineTpl", "footer"], ["*"]>;
}
