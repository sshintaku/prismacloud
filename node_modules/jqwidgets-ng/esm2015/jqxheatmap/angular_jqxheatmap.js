...
export class jqxHeatMapComponent {
...
jqxHeatMapComponent.propDecorators = {
    ...
    attrYAxis: [{ type: Input, args: ['yAxis',] }],
    attrPaletteSettings: [{ type: Input, args: ['paletteSettings',] }],
    attrLegendSettings: [{ type: Input, args: ['legendSettings',] }],
    attrSource: [{ type: Input, args: ['source',] }],
    attrTitle: [{ type: Input, args: ['title',] }],
    attrTooltipRender: [{ type: Input, args: ['tooltipRender',] }],
