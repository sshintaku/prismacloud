...
jqxSplitLayoutComponent.ctorParameters = () => [
    { type: ElementRef }
];
jqxSplitLayoutComponent.propDecorators = {
    attrDisabled: [{ type: Input, args: ['disabled',] }],
    attrDataSource: [{ type: Input, args: ['dataSource',] }],
...
export { jqxSplitLayoutComponent, jqxSplitLayoutModule };
