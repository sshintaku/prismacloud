...
jqxTimePickerComponent.propDecorators = {
    attrAutoSwitchToMinutes: [{ type: Input, args: ['autoSwitchToMinutes',] }],
    attrDisabled: [{ type: Input, args: ['disabled',] }],
    attrFooter: [{ type: Input, args: ['footer',] }],
    attrFooterTemplate: [{ type: Input, args: ['footerTemplate',] }],
    attrFormat: [{ type: Input, args: ['format',] }],
    attrMinuteInterval: [{ type: Input, args: ['minuteInterval',] }],
    attrName: [{ type: Input, args: ['name',] }],
    attrReadonly: [{ type: Input, args: ['readonly',] }],
    attrSelection: [{ type: Input, args: ['selection',] }],
    attrTheme: [{ type: Input, args: ['theme',] }],
    attrUnfocusable: [{ type: Input, args: ['unfocusable',] }],
